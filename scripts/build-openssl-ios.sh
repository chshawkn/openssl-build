...
UNIVERSAL_LIB_DIR="${script_path}/../output/${LIB_NAME}-ios-universal"
...
function  configure_make() {
    ...
    local PREFIX_DIR="${script_path}/../output/${LIB_NAME}-ios-${ABI_OR_RUST_ARCH}"
...
function create_universal_lib() {
    ...
    LIB_PATHS=( "${IOS_RUST_STYLE_ARCHS[@]/#/${script_path}/../output/${LIB_NAME}-ios-}" )
